...
declare var $: any;
@Component({
  selector: 'app-scriptincidence',
  templateUrl: './scriptincidence.component.html',
  styleUrls: ['./scriptincidence.component.css']
})
export class ScriptincidenceComponent implements OnInit  {
